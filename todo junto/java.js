function operacion() {
    ...
    if (numerador1 !== 0 && numerador2 !== 0 && denominador1 !== 0 && denominador2 !== 0) {
        ...
        alert("Rellene todos los campos numéricos correctamente");
    }
}
...
function initGame() {
    ...
    correctAnswerIndex = options.indexOf(correctValue);
...
function checkAnswer(selectedIndex) {
    ...
    if (selectedIndex === correctAnswerIndex) {
        document.getElementById(`circle-${selectedIndex}`).style.backgroundColor = '#10b981';
        clearInterval(timerInterval);
        isGameActive = false;
        document.getElementById('next-btn').style.display = 'inline-block';
    } else {
        document.getElementById(`circle-${selectedIndex}`).style.backgroundColor = '#ef4444';
    }
}
